...
Данные для подключения:
 ...
 При использованиии клиента [DBeawer](https://dbeaver.io/download/) есть возможность просмотра erd диаграммы таблиц базы данных. Для этого поле подключения необходимо открыть в дереве Базы данных/fastapi/Схемы/public. Щелкнуть правой кнопкой мыши по public и в выпавшем меню выбрать 'View Diagram'
